    ...
    if (is_front_page()) {
        ...
        <div class="intro-box-2">
            ...
            <div class="page-intro">
                ...
                <p class="f-button-wrapper" data-uk-scrollspy="{cls:'uk-animation-slide-bottom', delay:200}"><a href="http://localhost:8080/Feynmantheme/contact/" class="contact-buttons">Contact Us </a></p>
