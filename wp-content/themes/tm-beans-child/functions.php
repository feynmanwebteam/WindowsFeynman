  ...
  register_post_type( 'staff',
    array(
      'labels' => array(
        ...
        'singular_name' => __( 'Staff Membrer' )
      ),
      'public' => true,
      'has_archive' => true,
    )
...
// Set UI labels for Custom Post Type
	$labels = array(
		'name'                => _x( 'Staff Members', 'Post Type General Name', 'beans' ),
		'singular_name'       => _x( 'Staff member', 'Post Type Singular Name', 'beans' ),
		'menu_name'           => __( 'Staff Members', 'beans' ),
		'parent_item_colon'   => __( 'Parent Staff Member', 'beans' ),
		'all_items'           => __( 'All Staff Members', 'beans' ),
		'view_item'           => __( 'View Staff', 'beans' ),
		'add_new_item'        => __( 'Add New Staff Member', 'beans' ),
		'add_new'             => __( 'Add New', 'beans' ),
		'edit_item'           => __( 'Edit Staff Member', 'beans' ),
		'update_item'         => __( 'Update Staff Member', 'beans' ),
		'search_items'        => __( 'Search Staff Members', 'beans' ),
		'not_found'           => __( 'Not Found', 'beans' ),
		'not_found_in_trash'  => __( 'Not found in Trash', 'beans' ),
	);
...
// Set other options for Custom Post Type
	...
	$args = array(
		'label'               => __( '', 'beans' ),
		'description'         => __( 'Staff news and reviews', 'beans' ),
		'labels'              => $labels,
		// Features this CPT supports in Post Editor
		'supports'            => array( 'title', 'editor', 'excerpt', 'author', 'thumbnail', 'comments', 'revisions', 'custom-fields', ),
		// You can associate this CPT with a taxonomy or custom taxonomy. 
...
add_action( 'init', 'Testimonials_type', 0 );

function Testimonials_type() {

// Set UI labels for Custom Post Type
	$labels = array(
		'name'                => _x( 'Testimonials', 'Post Type General Name', 'beans' ),
		'singular_name'       => _x( 'Testimonials', 'Post Type Singular Name', 'beans' ),
		'menu_name'           => __( 'Testimonials', 'beans' ),
		'parent_item_colon'   => __( 'Parent Testimonials', 'beans' ),
		'all_items'           => __( 'All Testimonials', 'beans' ),
		'view_item'           => __( 'View Testimonials', 'beans' ),
		'add_new_item'        => __( 'Add New Testimonials', 'beans' ),
		'add_new'             => __( 'Add New', 'beans' ),
		'edit_item'           => __( 'Edit Testimonials', 'beans' ),
		'update_item'         => __( 'Update Testimonials', 'beans' ),
		'search_items'        => __( 'Search Testimonials', 'beans' ),
		'not_found'           => __( 'Not Found', 'beans' ),
		'not_found_in_trash'  => __( 'Not found in Trash', 'beans' ),
	);
